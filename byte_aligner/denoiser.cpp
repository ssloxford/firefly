...
// Locates synchronisation frames and decodes them according to the CCSDS pseudorandom
// noise function: x**8 + x**7 + x**5 + x**3 + 1.

// Default encoding table, from the generator polynomial
// From gov/nasa/gsfc/drl/rtstps/core/PnDecoder.java, originally from
// Gerald Grebowsky of GSFC in 1996

const std::bitset<8> table[] = {
