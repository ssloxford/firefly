...
We validate these conclusions experimentally by overshadowing a representative sample of real satellite communications, achieving internet traffic injection, dataset poisoning, and code execution to affect downstream systems.
We show that the necessary hardware can be assembled with commercially available components for <\$500 across all common satellite communication types.
