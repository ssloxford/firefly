...
\title{Exploiting Signal Injection Attacks against Satellite Downlink Communications}
...
\input{attack.tex} % describe the overall attack structure and hardware setup required
\input{threat_model.tex}
\input{evaluation.tex} % two experiments
\input{background.tex} % describe the related work
