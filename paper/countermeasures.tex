...
\textbf{TODO but a system employing these is much more versatile, should be protocol/modulation-agnostic}
...
Alongside the timing analysis techniques already mentioned, we can compare the cryptographic hashes of data received by multiple ground stations to ensure data has not changed or been tampered with at one location.
...
\textbf{TODO talk about how this could be used in conjunction with TDOA}
