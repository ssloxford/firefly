...
We see this problem occur in satellites such as GEO-KOMPSAT-2A, the keys to which were leaked with no mechanism to revoke or reset them -- this system is no longer secure and may never be again~\cite{xrit-rx}.
