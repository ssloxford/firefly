...
Terra and Aqua make use of the custom \textit{Channel Access Data Unit} (CADU) protocol, a fixed-length frame structure containing a synchronising header and checksum~\cite{spaceGroundAqua},p32.
The CADU is optionally Viterbi encoded to prevent desynchronisation during long runs of the same symbol.
...
% Talk about the principles required to make this work
