...
\title{Firefly: Forging Satellite Images through Radio Overshadowing}

% \title{Firefly: Exploiting Implicit Trust in Earth Oberservation Satellite Systems}
% Forging satellite data through radio injection
% \title{Firefly: Exploiting Implicit Trust in Satellite Packet-Based Downlink Processing Systems}
% Overshadowing to Exploit Implicit Trust in Satellite-Derived Dataset Generation
