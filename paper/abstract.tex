...
In this paper, we demonstrate that even the most prominent satellite image data processing systems, using NASA's Earth observing fleet as a case study, are vulnerable to a wide range of attacks due to implicitly trusting their input data.
We show that access to off-the-shelf radio hardware or simple social engineering techniques are sufficient to cause arbitrary image injection, denial of service, and remote code execution on the processing systems themselves.
