...
class qpsk_masked_encoder(gr.hier_block2):
    def __init__(self, excess_bw=0.350, freq_offset=0, noise=1, noise_volt=0.0001, time_offset=1.000):
        ...
        self.connect((self.blocks_char_to_float_2, 0), (self.blocks_float_to_complex_0, 0))
        ...
        self.connect((self.blocks_repeat_0, 0), (self.blocks_char_to_float_2, 0))
        ...
        self.connect((self, 1), (self.blocks_repeat_0, 0))
